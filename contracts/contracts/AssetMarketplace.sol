    ...
    ReentrancyGuardUpgradeable
{
    ...
    function initialize(
        ...
        require(feeManager_ != address(0), "Marketplace: zero fee manager");
    ...
    function buyFromIssuance(
        ...
        uint256 fee = IFeeManager(feeManager).computeMarketplaceFeePlaintext(totalCost);
        ...
        returns (uint256 totalCost, uint256 fee, uint256 netToTreasury)
    {
        ...
        fee = IFeeManager(feeManager).computeMarketplaceFeePlaintext(totalCost);
