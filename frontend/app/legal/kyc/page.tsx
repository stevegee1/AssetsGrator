    ...
    <div style={{ background: 'var(--bg)', minHeight: '100vh', padding: '3rem 0 5rem' }}>
      <div className="container" style={{ maxWidth: 780 }}>
        ...
        <Section title="8. Data Handling">
          <P>KYC data is handled in accordance with our <Link href="/legal/privacy" style={{ color: 'var(--brand)' }}>Privacy Policy</Link>. Sensitive identity documents are stored securely off-chain, and only the verification status flag is recorded on the blockchain.</P>
        </Section>
