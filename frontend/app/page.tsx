  ...
  return (
    <div>
      ...
      <section className="hero-section">
        ...
        />
        <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to bottom, rgba(0,0,0,0.2) 0%, rgba(0,0,0,0.65) 60%, rgba(0,0,0,0.88) 100%)' }} />

        <div style={{ position: 'relative', zIndex: 2, textAlign: 'center', padding: '0 1.25rem', maxWidth: 720, width: '100%' }}>
          ...
          <h1 className="hero-h1" style={{
            fontSize: 'clamp(1.9rem, 5vw, 3.5rem)', fontWeight: 900, color: '#fff',
          ...
          <p className="hero-sub" style={{
            color: 'rgba(255,255,255,0.82)', fontSize: 'clamp(0.9rem, 2vw, 1.1rem)',
            lineHeight: 1.6, maxWidth: 580, margin: '0 auto 1.25rem',
          }}>
          ...
          {/* Asset class chips */}
          <div className="hero-chips" style={{ display: 'flex', flexWrap: 'wrap', gap: 7, justifyContent: 'center', marginBottom: '1.25rem' }}>
            {[
              { emoji: '🏢', label: 'Commercial Real Estate' },
              { emoji: '☀️', label: 'Integrated Renewable Energy' },
              { emoji: '🌿', label: 'Carbon Credits' },
              { emoji: '⚡', label: 'Energy Certificates' },
            ].map(a => (
              <span key={a.label} style={{
                ...
                padding: '5px 12px', fontSize: 12, color: 'rgba(255,255,255,0.85)', fontWeight: 500,
              }}>
                {a.emoji} {a.label}
              </span>
            ))}
          ...
          <div className="hero-trust" style={{ display: 'flex', flexWrap: 'wrap', gap: 8, justifyContent: 'center', marginBottom: '1.5rem' }}>
            {['✓ ERC-3643', '✓ FHE-Encrypted', '✓ Legally Backed', '✓ KYC-Gated'].map(chip => (
              <span key={chip} style={{
                background: 'rgba(255,255,255,0.12)', backdropFilter: 'blur(6px)',
                border: '1px solid rgba(255,255,255,0.2)', borderRadius: 100,
                padding: '5px 13px', fontSize: 12, color: '#fff', fontWeight: 500,
              }}>{chip}</span>
            ))}
          </div>

          {/* Stats */}
          <div className="hero-stats" style={{ display: 'flex', justifyContent: 'center', gap: '2.5rem', flexWrap: 'wrap', marginBottom: '1.75rem' }}>
            {[
